...
{
    public partial class ConStr_ConStrInPython : Form
    {
        ...
        public ConStr_ConStrInPython(string username)
        {
            InitializeComponent();
        ...
        private void ConStr_ConStrInPython_Load(object sender, EventArgs e)
        {
