...
{
    public partial class Intro_BasicCommands : Form
    {
        ...
        public Intro_BasicCommands(string username)
        {
            InitializeComponent();
        ...
        private void Intro_BasicCommands_Load(object sender, EventArgs e)
        {
