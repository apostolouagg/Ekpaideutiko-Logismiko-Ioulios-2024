...
{
    public partial class Vars_VarNamesAndAssignment : Form
    {
        ...
        public Vars_VarNamesAndAssignment(string username)
        {
            InitializeComponent();
        ...
        private void Vars_VarNamesAndAssignment_Load(object sender, EventArgs e)
        {
